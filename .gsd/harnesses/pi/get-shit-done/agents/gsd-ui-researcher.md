...
Use template from `.pi/gsd/templates/UI-SPEC.md`.
...
Read template: `.pi/gsd/templates/UI-SPEC.md`
...
```bash
pi-gsd-tools commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
