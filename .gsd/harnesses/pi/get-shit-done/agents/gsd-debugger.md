...
tools: Read, Write, Edit, Bash, Grep, Glob, WebSearch, mcp__muninn__*
...
```bash
pi-gsd-tools commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
pi-gsd-tools commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
